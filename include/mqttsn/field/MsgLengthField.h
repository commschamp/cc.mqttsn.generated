...
struct MsgLengthFieldMembers
{
    ...
    public:
        ...
        {
            return mqttsn::field::MsgLengthFieldMembersCommon::ShortCommon::hasSpecials();
        }
    ...
    struct LongMembers
    {
        ...
        public:
            ...
            static constexpr bool hasSpecials()
            {
                return mqttsn::field::MsgLengthFieldMembersCommon::LongMembersCommon::LongCommon::hasSpecials();
            }
...
public:
    ...
    ///     @li @b FieldIdx_shortindex, @b Field_shorttype and @b field_short() access function -
    ///         for MsgLengthFieldMembers::Short member field.
    ///     @li @b FieldIdx_longindex, @b Field_longtype and @b field_long() access function -
