...
/// @file
/// @brief Contains message factory with dynamic memory allocation for the server input "Prot" platform specific messages.
...
/// @brief Message factory with dynamic memory allocation for the server input "Prot" platform specific messages.
...
class ProtServerInputMessagesDynMemMsgFactory
{
public:
