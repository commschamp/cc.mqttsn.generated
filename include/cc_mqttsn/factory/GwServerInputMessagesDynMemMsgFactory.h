...
/// @file
/// @brief Contains message factory with dynamic memory allocation for the server input "Gw" platform specific messages.
...
/// @brief Message factory with dynamic memory allocation for the server input "Gw" platform specific messages.
...
class GwServerInputMessagesDynMemMsgFactory
{
public:
