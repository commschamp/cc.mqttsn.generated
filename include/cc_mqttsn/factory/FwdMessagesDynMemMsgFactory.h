...
/// @file
/// @brief Contains message factory with dynamic memory allocation for all the "Fwd" platform specific messages.
...
/// @brief Message factory with dynamic memory allocation for all the "Fwd" platform specific messages.
...
class FwdMessagesDynMemMsgFactory
{
public:
