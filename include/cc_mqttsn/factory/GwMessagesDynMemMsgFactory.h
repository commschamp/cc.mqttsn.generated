...
/// @file
/// @brief Contains message factory with dynamic memory allocation for all the "Gw" platform specific messages.
...
/// @brief Message factory with dynamic memory allocation for all the "Gw" platform specific messages.
...
class GwMessagesDynMemMsgFactory
{
public:
