...
public:
    ...
    MsgPtr createMsg(MsgIdParamType id, unsigned idx = 0U, CreateFailureReason* reason = nullptr) const
    {
        ...
        switch (static_cast<std::intmax_t>(id)) {
            ...
            case 4 /* 0x4 */: return MsgPtr(new cc_mqttsn::message::Connect<TInterface, TProtOptions>);
            ...
            case 7 /* 0x7 */: return MsgPtr(new cc_mqttsn::message::Willtopic<TInterface, TProtOptions>);
            case 8 /* 0x8 */: return MsgPtr(new cc_mqttsn::message::Willmsgreq<TInterface, TProtOptions>);
            case 9 /* 0x9 */: return MsgPtr(new cc_mqttsn::message::Willmsg<TInterface, TProtOptions>);
            ...
            case 18 /* 0x12 */: return MsgPtr(new cc_mqttsn::message::Subscribe<TInterface, TProtOptions>);
            case 19 /* 0x13 */: return MsgPtr(new cc_mqttsn::message::Suback<TInterface, TProtOptions>);
            case 20 /* 0x14 */: return MsgPtr(new cc_mqttsn::message::Unsubscribe<TInterface, TProtOptions>);
            ...
            case 26 /* 0x1a */: return MsgPtr(new cc_mqttsn::message::Willtopicupd<TInterface, TProtOptions>);
            case 27 /* 0x1b */: return MsgPtr(new cc_mqttsn::message::Willtopicresp<TInterface, TProtOptions>);
            case 28 /* 0x1c */: return MsgPtr(new cc_mqttsn::message::Willmsgupd<TInterface, TProtOptions>);
    ...
    std::size_t msgCount(MsgIdParamType id) const
    {
        switch (static_cast<std::intmax_t>(id))
        {
            ...
            case 19 /* 0x13 */: return 1;
            case 20 /* 0x14 */: return 1;
            case 21 /* 0x15 */: return 1;
            case 22 /* 0x16 */: return 1;
            case 23 /* 0x17 */: return 1;
            case 24 /* 0x18 */: return 1;
            case 26 /* 0x1a */: return 1;
            case 27 /* 0x1b */: return 1;
            case 28 /* 0x1c */: return 1;
            case 29 /* 0x1d */: return 1;
            case 254 /* 0xfe */: return 1;
            default: break;
        }
