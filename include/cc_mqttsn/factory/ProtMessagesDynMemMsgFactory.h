...
/// @file
/// @brief Contains message factory with dynamic memory allocation for all the "Prot" platform specific messages.
...
/// @brief Message factory with dynamic memory allocation for all the "Prot" platform specific messages.
...
class ProtMessagesDynMemMsgFactory
{
public:
    ...
    MsgPtr createMsg(MsgIdParamType id, unsigned idx = 0U, CreateFailureReason* reason = nullptr) const
    {
        ...
        switch (id) {
            ...
            case cc_mqttsn::MsgId_Connect: return MsgPtr(new cc_mqttsn::message::Connect<TInterface, TProtOptions>);
            ...
            case cc_mqttsn::MsgId_Willtopic: return MsgPtr(new cc_mqttsn::message::Willtopic<TInterface, TProtOptions>);
            case cc_mqttsn::MsgId_Willmsgreq: return MsgPtr(new cc_mqttsn::message::Willmsgreq<TInterface, TProtOptions>);
            case cc_mqttsn::MsgId_Willmsg: return MsgPtr(new cc_mqttsn::message::Willmsg<TInterface, TProtOptions>);
            case cc_mqttsn::MsgId_Register: return MsgPtr(new cc_mqttsn::message::Register<TInterface, TProtOptions>);
            case cc_mqttsn::MsgId_Regack: return MsgPtr(new cc_mqttsn::message::Regack<TInterface, TProtOptions>);
            case cc_mqttsn::MsgId_Publish: return MsgPtr(new cc_mqttsn::message::Publish<TInterface, TProtOptions>);
            case cc_mqttsn::MsgId_Puback: return MsgPtr(new cc_mqttsn::message::Puback<TInterface, TProtOptions>);
            case cc_mqttsn::MsgId_Pubcomp: return MsgPtr(new cc_mqttsn::message::Pubcomp<TInterface, TProtOptions>);
            case cc_mqttsn::MsgId_Pubrec: return MsgPtr(new cc_mqttsn::message::Pubrec<TInterface, TProtOptions>);
