...
/// @file
/// @brief Contains message factory with dynamic memory allocation for the client input "Fwd" platform specific messages.
...
/// @brief Message factory with dynamic memory allocation for the client input "Fwd" platform specific messages.
...
class FwdClientInputMessagesDynMemMsgFactory
{
public:
