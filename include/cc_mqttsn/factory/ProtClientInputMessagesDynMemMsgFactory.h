...
/// @file
/// @brief Contains message factory with dynamic memory allocation for the client input "Prot" platform specific messages.
...
/// @brief Message factory with dynamic memory allocation for the client input "Prot" platform specific messages.
...
class ProtClientInputMessagesDynMemMsgFactory
{
public:
