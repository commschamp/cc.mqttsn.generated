...
/// @file
/// @brief Contains message factory with dynamic memory allocation for the server input "Fwd" platform specific messages.
...
/// @brief Message factory with dynamic memory allocation for the server input "Fwd" platform specific messages.
...
class FwdServerInputMessagesDynMemMsgFactory
{
public:
