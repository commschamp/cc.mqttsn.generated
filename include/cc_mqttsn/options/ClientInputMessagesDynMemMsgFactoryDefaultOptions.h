...
#include "cc_mqttsn/factory/ClientInputMessagesDynMemMsgFactory.h"
...
{
    /// @brief Alias to @ref cc_mqttsn::factory::ClientInputMessagesDynMemMsgFactory message factory.
    ...
    using MsgFactory = cc_mqttsn::factory::ClientInputMessagesDynMemMsgFactory<TInterface, ClientInputMessagesDynMemMsgFactoryDefaultOptionsT<TBase> >;
