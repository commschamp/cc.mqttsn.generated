...
{
    /// @brief Alias to @ref cc_mqttsn::factory::ProtServerInputMessagesDynMemMsgFactory message factory.
    ...
    using MsgFactory = cc_mqttsn::factory::ProtServerInputMessagesDynMemMsgFactory<TInterface, ProtServerInputMessagesDynMemMsgFactoryDefaultOptionsT<TBase> >;
