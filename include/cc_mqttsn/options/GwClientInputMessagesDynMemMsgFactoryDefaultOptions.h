...
{
    /// @brief Alias to @ref cc_mqttsn::factory::GwClientInputMessagesDynMemMsgFactory message factory.
    ...
    using MsgFactory = cc_mqttsn::factory::GwClientInputMessagesDynMemMsgFactory<TInterface, GwClientInputMessagesDynMemMsgFactoryDefaultOptionsT<TBase> >;
