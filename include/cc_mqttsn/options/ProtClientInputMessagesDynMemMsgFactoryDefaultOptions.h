...
{
    /// @brief Alias to @ref cc_mqttsn::factory::ProtClientInputMessagesDynMemMsgFactory message factory.
    ...
    using MsgFactory = cc_mqttsn::factory::ProtClientInputMessagesDynMemMsgFactory<TInterface, ProtClientInputMessagesDynMemMsgFactoryDefaultOptionsT<TBase> >;
