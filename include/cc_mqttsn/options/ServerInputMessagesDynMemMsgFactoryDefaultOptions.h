...
#include "cc_mqttsn/factory/ServerInputMessagesDynMemMsgFactory.h"
...
{
    /// @brief Alias to @ref cc_mqttsn::factory::ServerInputMessagesDynMemMsgFactory message factory.
    ...
    using MsgFactory = cc_mqttsn::factory::ServerInputMessagesDynMemMsgFactory<TInterface, ServerInputMessagesDynMemMsgFactoryDefaultOptionsT<TBase> >;
