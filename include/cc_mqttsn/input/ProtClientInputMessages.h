...
/// @file
/// @brief Contains definition of the ProtClientInputMessages messages bundle.
...
/// @brief Client input Prot platform messages of the protocol in ascending order.
...
/// @brief Create type aliases for the client input prot platform messages of the protocol.
...
/// @brief Create type aliases for the client input prot platform messages of the protocol using default options.
/// @param prefix_ Prefix of the alias message type.
/// @param suffix_ Suffix of the alias message type.
/// @param interface_ Type of the common message interface.
#define CC_MQTTSN_ALIASES_FOR_PROT_CLIENT_INPUT_MESSAGES_DEFAULT_OPTIONS(prefix_, suffix_, interface_) \
    CC_MQTTSN_ALIASES_FOR_PROT_CLIENT_INPUT_MESSAGES(prefix_, suffix_, interface_, cc_mqttsn::options::DefaultOptions)
