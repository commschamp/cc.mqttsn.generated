...
/// @file
/// @brief Contains definition of the GwServerInputMessages messages bundle.
...
/// @brief Server input Gw platform messages of the protocol in ascending order.
/// @tparam TBase Base class of all the messages.
/// @tparam TOpt Protocol definition options.
template <typename TBase, typename TOpt = cc_mqttsn::options::DefaultOptions>
using GwServerInputMessages =
    std::tuple<
...
/// @brief Create type aliases for the server input gw platform messages of the protocol.
/// @param prefix_ Prefix of the alias message type.
/// @param suffix_ Suffix of the alias message type.
/// @param interface_ Type of the common message interface.
/// @param opts_ Type of the used protocol definition options.
#define CC_MQTTSN_ALIASES_FOR_GW_SERVER_INPUT_MESSAGES(prefix_, suffix_, interface_, opts_) \
...
/// @brief Create type aliases for the server input gw platform messages of the protocol using default options.
/// @param prefix_ Prefix of the alias message type.
/// @param suffix_ Suffix of the alias message type.
/// @param interface_ Type of the common message interface.
#define CC_MQTTSN_ALIASES_FOR_GW_SERVER_INPUT_MESSAGES_DEFAULT_OPTIONS(prefix_, suffix_, interface_) \
    CC_MQTTSN_ALIASES_FOR_GW_SERVER_INPUT_MESSAGES(prefix_, suffix_, interface_, cc_mqttsn::options::DefaultOptions)
