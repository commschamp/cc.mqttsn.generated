...
/// @file
/// @brief Contains definition of the FwdClientInputMessages messages bundle.
...
/// @brief Client input Fwd platform messages of the protocol in ascending order.
...
/// @brief Create type aliases for the client input fwd platform messages of the protocol.
...
/// @param suffix_ Suffix of the alias message type.
/// @param interface_ Type of the common message interface.
#define CC_MQTTSN_ALIASES_FOR_FWD_CLIENT_INPUT_MESSAGES_DEFAULT_OPTIONS(prefix_, suffix_, interface_) \
    CC_MQTTSN_ALIASES_FOR_FWD_CLIENT_INPUT_MESSAGES(prefix_, suffix_, interface_, cc_mqttsn::options::DefaultOptions)
