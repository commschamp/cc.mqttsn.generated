...
/// @file
/// @brief Contains dispatch to handling function(s) for Gw platform client input input messages.
...
/// @note Defined in cc_mqttsn/dispatch/DispatchGwClientInputMessage.h
template<typename TProtOptions, typename TId, typename TMsg, typename THandler>
auto dispatchGwClientInputMessage(
    TId id,
    TMsg& msg,
...
/// @brief Dispatch message object to its appropriate handling function.
/// @details Same as other dispatchGwClientInputMessage(), but receives extra @b idx parameter.
/// @tparam TProtOptions Protocol options struct used for the application,
///     like @ref cc_mqttsn::options::DefaultOptions.
/// @param[in] id Numeric message ID.
...
/// @see dispatchGwClientInputMessage()
/// @note Defined in cc_mqttsn/dispatch/DispatchGwClientInputMessage.h
template<typename TProtOptions, typename TId, typename TMsg, typename THandler>
auto dispatchGwClientInputMessage(
    TId id,
    ...
    THandler& handler) -> decltype(handler.handle(msg))
{
    ...
    return dispatchGwClientInputMessage<TProtOptions>(id, msg, handler);
}

/// @brief Dispatch message object to its appropriate handling function.
/// @details Same as other dispatchGwClientInputMessage(), but passing
...
auto dispatchGwClientInputMessageDefaultOptions(
    TId id,
    TMsg& msg,
    THandler& handler) -> decltype(handler.handle(msg))
{
    return dispatchGwClientInputMessage<cc_mqttsn::options::DefaultOptions>(id, msg, handler);
}

/// @brief Dispatch message object to its appropriate handling function.
/// @details Same as other dispatchGwClientInputMessageDefaultOptions(), 
///     but receives extra @b idx parameter.
/// @param[in] id Numeric message ID.
/// @param[in] idx Index of the message among messages with the same ID.
/// @param[in] msg Message object held by reference to its interface class.
/// @param[in] handler Reference to handling object.
/// @see dispatchGwClientInputMessageDefaultOptions()
/// @note Defined in cc_mqttsn/dispatch/DispatchGwClientInputMessage.h
template<typename TId, typename TMsg, typename THandler>
auto dispatchGwClientInputMessageDefaultOptions(
    TId id,
    ...
    THandler& handler) -> decltype(handler.handle(msg))
{
    return dispatchGwClientInputMessage<cc_mqttsn::options::DefaultOptions>(id, idx, msg, handler);
}
...
/// @tparam TProtOptions Protocol options struct used for the application,
///     like @ref cc_mqttsn::options::DefaultOptions.
/// @headerfile cc_mqttsn/dispatch/DispatchGwClientInputMessage.h
template <typename TProtOptions = cc_mqttsn::options::DefaultOptions>
struct GwClientInputMsgDispatcher
{
    /// @brief Class detection tag
    using MsgDispatcherTag = void;

    /// @brief Dispatch message to its handler.
    /// @details Uses appropriate @ref dispatchGwClientInputMessage() function.
    ...
    /// @return What the @ref dispatchGwClientInputMessage() function returns.
    template <typename TId, typename TMsg, typename THandler>
    static auto dispatch(TId id, std::size_t idx, TMsg& msg, THandler& handler) ->
        decltype(cc_mqttsn::dispatch::dispatchGwClientInputMessage<TProtOptions>(id, idx, msg, handler))
    {
        return cc_mqttsn::dispatch::dispatchGwClientInputMessage<TProtOptions>(id, idx, msg, handler);
    }
    ...
    static auto dispatch(TId id, TMsg& msg, THandler& handler) ->
        decltype(cc_mqttsn::dispatch::dispatchGwClientInputMessage<TProtOptions>(id, msg, handler))
    {
        return cc_mqttsn::dispatch::dispatchGwClientInputMessage<TProtOptions>(id, msg, handler);
    }
...
/// @brief Message dispatcher class to be used with
///     @b comms::processAllWithDispatchViaDispatcher() function (or similar).
/// @details Same as GwClientInputMsgDispatcher, but passing
///     @ref cc_mqttsn::options::DefaultOptions as template parameter.
/// @note Defined in cc_mqttsn/dispatch/DispatchGwClientInputMessage.h
using GwClientInputMsgDispatcherDefaultOptions =
    GwClientInputMsgDispatcher<>;
