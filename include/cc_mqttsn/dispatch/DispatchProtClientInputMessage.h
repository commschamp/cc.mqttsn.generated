...
/// @file
/// @brief Contains dispatch to handling function(s) for Prot platform client input input messages.
...
/// @note Defined in cc_mqttsn/dispatch/DispatchProtClientInputMessage.h
template<typename TProtOptions, typename TId, typename TMsg, typename THandler>
auto dispatchProtClientInputMessage(
    TId id,
    TMsg& msg,
...
/// @brief Dispatch message object to its appropriate handling function.
/// @details Same as other dispatchProtClientInputMessage(), but receives extra @b idx parameter.
/// @tparam TProtOptions Protocol options struct used for the application,
///     like @ref cc_mqttsn::options::DefaultOptions.
/// @param[in] id Numeric message ID.
...
/// @see dispatchProtClientInputMessage()
/// @note Defined in cc_mqttsn/dispatch/DispatchProtClientInputMessage.h
template<typename TProtOptions, typename TId, typename TMsg, typename THandler>
auto dispatchProtClientInputMessage(
    TId id,
    ...
    THandler& handler) -> decltype(handler.handle(msg))
{
    ...
    return dispatchProtClientInputMessage<TProtOptions>(id, msg, handler);
}

/// @brief Dispatch message object to its appropriate handling function.
/// @details Same as other dispatchProtClientInputMessage(), but passing
...
auto dispatchProtClientInputMessageDefaultOptions(
    TId id,
    TMsg& msg,
    THandler& handler) -> decltype(handler.handle(msg))
{
    return dispatchProtClientInputMessage<cc_mqttsn::options::DefaultOptions>(id, msg, handler);
}

/// @brief Dispatch message object to its appropriate handling function.
/// @details Same as other dispatchProtClientInputMessageDefaultOptions(), 
///     but receives extra @b idx parameter.
/// @param[in] id Numeric message ID.
/// @param[in] idx Index of the message among messages with the same ID.
/// @param[in] msg Message object held by reference to its interface class.
/// @param[in] handler Reference to handling object.
/// @see dispatchProtClientInputMessageDefaultOptions()
/// @note Defined in cc_mqttsn/dispatch/DispatchProtClientInputMessage.h
template<typename TId, typename TMsg, typename THandler>
auto dispatchProtClientInputMessageDefaultOptions(
    TId id,
    ...
    THandler& handler) -> decltype(handler.handle(msg))
{
    return dispatchProtClientInputMessage<cc_mqttsn::options::DefaultOptions>(id, idx, msg, handler);
}
...
/// @tparam TProtOptions Protocol options struct used for the application,
///     like @ref cc_mqttsn::options::DefaultOptions.
/// @headerfile cc_mqttsn/dispatch/DispatchProtClientInputMessage.h
template <typename TProtOptions = cc_mqttsn::options::DefaultOptions>
struct ProtClientInputMsgDispatcher
{
    /// @brief Class detection tag
    using MsgDispatcherTag = void;

    /// @brief Dispatch message to its handler.
    /// @details Uses appropriate @ref dispatchProtClientInputMessage() function.
    ...
    /// @return What the @ref dispatchProtClientInputMessage() function returns.
    template <typename TId, typename TMsg, typename THandler>
    static auto dispatch(TId id, std::size_t idx, TMsg& msg, THandler& handler) ->
        decltype(cc_mqttsn::dispatch::dispatchProtClientInputMessage<TProtOptions>(id, idx, msg, handler))
    {
        return cc_mqttsn::dispatch::dispatchProtClientInputMessage<TProtOptions>(id, idx, msg, handler);
    }
    ...
    static auto dispatch(TId id, TMsg& msg, THandler& handler) ->
        decltype(cc_mqttsn::dispatch::dispatchProtClientInputMessage<TProtOptions>(id, msg, handler))
    {
        return cc_mqttsn::dispatch::dispatchProtClientInputMessage<TProtOptions>(id, msg, handler);
    }
...
/// @brief Message dispatcher class to be used with
///     @b comms::processAllWithDispatchViaDispatcher() function (or similar).
/// @details Same as ProtClientInputMsgDispatcher, but passing
///     @ref cc_mqttsn::options::DefaultOptions as template parameter.
/// @note Defined in cc_mqttsn/dispatch/DispatchProtClientInputMessage.h
using ProtClientInputMsgDispatcherDefaultOptions =
    ProtClientInputMsgDispatcher<>;
