...
/// @file
/// @brief Contains dispatch to handling function(s) for Prot platform server input input messages.

#pragma once

#include <cstdint>
#include "cc_mqttsn/input/ProtServerInputMessages.h"
...
/// @note Defined in cc_mqttsn/dispatch/DispatchProtServerInputMessage.h
template<typename TProtOptions, typename TId, typename TMsg, typename THandler>
auto dispatchProtServerInputMessage(
    TId id,
    TMsg& msg,
...
/// @brief Dispatch message object to its appropriate handling function.
/// @details Same as other dispatchProtServerInputMessage(), but receives extra @b idx parameter.
/// @tparam TProtOptions Protocol options struct used for the application,
///     like @ref cc_mqttsn::options::DefaultOptions.
/// @param[in] id Numeric message ID.
...
/// @see dispatchProtServerInputMessage()
/// @note Defined in cc_mqttsn/dispatch/DispatchProtServerInputMessage.h
template<typename TProtOptions, typename TId, typename TMsg, typename THandler>
auto dispatchProtServerInputMessage(
    TId id,
    ...
    THandler& handler) -> decltype(handler.handle(msg))
{
    ...
    return dispatchProtServerInputMessage<TProtOptions>(id, msg, handler);
}

/// @brief Dispatch message object to its appropriate handling function.
/// @details Same as other dispatchProtServerInputMessage(), but passing
...
auto dispatchProtServerInputMessageDefaultOptions(
    TId id,
    TMsg& msg,
    THandler& handler) -> decltype(handler.handle(msg))
{
    return dispatchProtServerInputMessage<cc_mqttsn::options::DefaultOptions>(id, msg, handler);
}

/// @brief Dispatch message object to its appropriate handling function.
/// @details Same as other dispatchProtServerInputMessageDefaultOptions(), 
///     but receives extra @b idx parameter.
/// @param[in] id Numeric message ID.
/// @param[in] idx Index of the message among messages with the same ID.
/// @param[in] msg Message object held by reference to its interface class.
/// @param[in] handler Reference to handling object.
/// @see dispatchProtServerInputMessageDefaultOptions()
/// @note Defined in cc_mqttsn/dispatch/DispatchProtServerInputMessage.h
template<typename TId, typename TMsg, typename THandler>
auto dispatchProtServerInputMessageDefaultOptions(
    TId id,
    ...
    THandler& handler) -> decltype(handler.handle(msg))
{
    return dispatchProtServerInputMessage<cc_mqttsn::options::DefaultOptions>(id, idx, msg, handler);
}
...
/// @tparam TProtOptions Protocol options struct used for the application,
///     like @ref cc_mqttsn::options::DefaultOptions.
/// @headerfile cc_mqttsn/dispatch/DispatchProtServerInputMessage.h
template <typename TProtOptions = cc_mqttsn::options::DefaultOptions>
struct ProtServerInputMsgDispatcher
{
    /// @brief Class detection tag
    using MsgDispatcherTag = void;

    /// @brief Dispatch message to its handler.
    /// @details Uses appropriate @ref dispatchProtServerInputMessage() function.
    ...
    /// @return What the @ref dispatchProtServerInputMessage() function returns.
    template <typename TId, typename TMsg, typename THandler>
    static auto dispatch(TId id, std::size_t idx, TMsg& msg, THandler& handler) ->
        decltype(cc_mqttsn::dispatch::dispatchProtServerInputMessage<TProtOptions>(id, idx, msg, handler))
    {
        return cc_mqttsn::dispatch::dispatchProtServerInputMessage<TProtOptions>(id, idx, msg, handler);
    }
    ...
    static auto dispatch(TId id, TMsg& msg, THandler& handler) ->
        decltype(cc_mqttsn::dispatch::dispatchProtServerInputMessage<TProtOptions>(id, msg, handler))
    {
        return cc_mqttsn::dispatch::dispatchProtServerInputMessage<TProtOptions>(id, msg, handler);
    }
...
/// @brief Message dispatcher class to be used with
///     @b comms::processAllWithDispatchViaDispatcher() function (or similar).
/// @details Same as ProtServerInputMsgDispatcher, but passing
///     @ref cc_mqttsn::options::DefaultOptions as template parameter.
/// @note Defined in cc_mqttsn/dispatch/DispatchProtServerInputMessage.h
using ProtServerInputMsgDispatcherDefaultOptions =
    ProtServerInputMsgDispatcher<>;
