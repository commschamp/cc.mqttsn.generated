...
#include "cc_mqttsn/message/PubrelCommon.h"
...
/// @see @ref Pubrel
/// @headerfile cc_mqttsn/message/Pubrel.h
...
class Pubrel : public
    comms::MessageBase<
        TMsgBase,
        comms::option::def::StaticNumIdImpl<cc_mqttsn::MsgId_Pubrel>,
...
public:
    ...
    {
        return cc_mqttsn::message::PubrelCommon::name();
    }
};
